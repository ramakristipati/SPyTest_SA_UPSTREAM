...
def get_inventory_csv(prefix=None, consolidated=False):
    return get_file_path("inventory", "csv", prefix, consolidated)

def get_inventory_htm(prefix=None, consolidated=False):
    return get_file_path("inventory", "html", prefix, consolidated)
