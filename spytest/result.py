...
slave_cols4 = ["#", "Module", "DUTs", "MEM-INITIAL", "MEM-FINAL", "MEM-DIFF"]
slave_cols4.extend(cpu_cols)
slave_cols5 = ["#", "Name", "Value"]
slave_cols6 = ['Feature', 'Regression?', 'TestCase', 'Result', 'Description', 'Function', 'Module', "Devices",
               'Analisis', 'DUT Defect ID', 'SQA Defect ID', 'Engineer', 'Only Pending']
slave_cols7 = ["#", "Module", "Devices", "Models", "Chips", "TGen", "Count", "Pass", "Rate", "Time"]
slave_cols8 = ["#", "Module", "Function", "DUTs", "MEM-INITIAL", "MEM-FINAL", "MEM-DIFF"]
slave_cols8.extend(cpu_cols)
slave_cols9 = ["#", "Module", "Function", "DUT", "MEM-INITIAL", "MEM-FINAL", "MEM-DIFF"]
slave_cols9.extend(cpu_cols)
slave_cols10 = ["#", "DUT", "Model", "Chip", "Build"]
slave_cols11 = ["#"]
slave_cols12 = ["#", "DUT", "Name", "Value", "Platform", "Chip", "Build", "Module", "Function"]
slave_cols13 = ["#", "DUT", "Name", "Value", "Platform", "Chip", "Build", "Module", "Function"]

slave_cols = [slave_cols0, slave_cols1, slave_cols2, slave_cols3, slave_cols4,
              slave_cols5, slave_cols6, slave_cols7, slave_cols8, slave_cols9,
              slave_cols10, slave_cols11, slave_cols12, slave_cols13]

def default_merge(slave):
    retval = ["#", "Node"]
    retval.extend(slave[1:])
    return retval

merge_cols0 = default_merge(slave_cols0)
merge_cols1 = default_merge(slave_cols1)
merge_cols2 = default_merge(slave_cols2)
merge_cols3 = default_merge(slave_cols3)
merge_cols4 = default_merge(slave_cols4)
merge_cols5 = slave_cols5
merge_cols6 = slave_cols6
merge_cols7 = default_merge(slave_cols7)
merge_cols8 = default_merge(slave_cols8)
merge_cols9 = default_merge(slave_cols9)
merge_cols10 = slave_cols10
merge_cols11 = default_merge(slave_cols11)
merge_cols12 = default_merge(slave_cols12)
merge_cols13 = default_merge(slave_cols13)
