...
def base_unconfig():
    ...
    for vrf,dut1_as,dut2_as in zip(vrf_list[bgp_vrfs_start:bgp_vrfs_end],dut1_as_scale[0:100],dut2_as_scale[0:100]):
...
def test_vrf_bgp():
    ...
    for vrf, dut1_ip, dut2_ip, dut1_as, dut2_as in zip(vrf_list[bgp_vrfs_start:bgp_vrfs_end], data.dut1_dut2_ip_list[bgp_vrfs_start:bgp_vrfs_end], data.dut2_dut1_ip_list[bgp_vrfs_start:bgp_vrfs_end], dut1_as_scale[0:100], dut2_as_scale[0:100]):
