...
def verify_v4_bgp_neigborship():
    ...
    if not bgp_obj.verify_bgp_neighborship(vars.D1, family=data.af_ipv4, shell=data.shell_vtysh,
                                      neighbor=data.neigh_ip_addr, state='Established', asn=data.remote_asn4, delay=5):
    ...
    if not bgp_obj.verify_bgp_neighborship(vars.D2, family=data.af_ipv4, shell=data.shell_vtysh,
                                      neighbor=data.local_ip_addr, state='Established', asn=data.local_asn4, delay=5):
    ...
    if not bgp_obj.verify_bgp_neighborship(vars.D1, family=data.af_ipv4, shell=data.shell_vtysh,
                                      neighbor=data.t1d1_ip_addr, state='Established', asn=data.local_asn4, delay=5):
...
def verify_v6_bgp_neigborship():
    ...
    if not bgp_obj.verify_bgp_neighborship(vars.D1, family=data.af_ipv6, shell=data.shell_vtysh,
                                      neighbor=data.neigh_ip6_addr, state='Established', asn=data.remote_asn4, delay=5):
    ...
    if not bgp_obj.verify_bgp_neighborship(vars.D2, family=data.af_ipv6, shell=data.shell_vtysh,
                                      neighbor=data.local_ip6_addr, state='Established', asn=data.local_asn4, delay=5):
    ...
    if not bgp_obj.verify_bgp_neighborship(vars.D1, family=data.af_ipv6, shell=data.shell_vtysh,
                                      neighbor=data.t1d1_ip6_addr, state='Established', asn=data.local_asn4, delay=5):
...
@pytest.mark.inventory(testcases=['ft_bgp_v6peer_asn4_cfg_fast_reboot'])
@pytest.mark.inventory(testcases=['ft_bgp_v4peer_asn4_cfg_fast_reboot'])
