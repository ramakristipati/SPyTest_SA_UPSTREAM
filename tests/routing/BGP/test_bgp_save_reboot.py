...
@pytest.mark.inventory(testcases=['ft_bgp_v6peer_asn4_save_reboot'])
@pytest.mark.inventory(testcases=['ft_bgp_v4peer_asn4_save_reboot'])
@pytest.mark.inventory(testcases=['ft_bgp_v6peer_asn4_cfg_save_reload'])
@pytest.mark.inventory(testcases=['ft_bgp_v4peer_asn4_cfg_save_reload'])
