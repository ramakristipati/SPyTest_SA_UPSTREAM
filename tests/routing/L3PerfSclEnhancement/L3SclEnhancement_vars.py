...
data.tg_dut2_p1_route_prefix = '11.0.0.1'
data.tg_dut2_p1_v6_routes = '500'
data.tg_dut2_p1_route_prefix = '11::1'
...
TH3 = SpyTestDict()
TH3.ipv4_scale = 196000
TH3.ipv6_scale = 32000
TH3.ipv6_scale_abv_64 = 25000
TH3.ipv4_scale_ipv4ipv6 =  80000
TH3.ipv6_scale_ipv4ipv6 =  12000
TH3.wait_time = 140
TH3.delay_time = 10
TH3.retry_time = 11
TH3.perf_time = 5
TH3.max_arp_count = 32000
TH3.max_nd_count = 16000
...
TD3.retry_time = 8
TD3.perf_time = 3
TD3.max_arp_count = 16000
TD3.max_nd_count = 8000

TD3X3 = SpyTestDict()
TD3X3.ipv4_scale = 8000
TD3X3.ipv6_scale = 4000
TD3X3.ipv6_scale_abv_64 = 2000
TD3X3.ipv4_scale_ipv4ipv6 =  4000
TD3X3.ipv6_scale_ipv4ipv6 =  4000
TD3X3.wait_time = 120
TD3X3.delay_time = 7
TD3X3.retry_time = 8
TD3X3.perf_time = 3
TD3X3.max_arp_count = 10000
TD3X3.max_nd_count = 5000

#Td3X3 v4 bank to support more ipv6 routes on AS4630 PE and TE devices
TD3X3V4Bank = SpyTestDict()
TD3X3V4Bank.ipv4_scale = 79990
TD3X3V4Bank.ipv6_scale = 32000
TD3X3V4Bank.ipv6_scale_abv_64 = 1000
TD3X3V4Bank.ipv4_scale_ipv4ipv6 =  4000
TD3X3V4Bank.ipv6_scale_ipv4ipv6 =  4000
TD3X3V4Bank.wait_time = 120
TD3X3V4Bank.delay_time = 7
TD3X3V4Bank.retry_time = 8
TD3X3V4Bank.perf_time = 3
TD3X3V4Bank.max_arp_count = 16000
TD3X3V4Bank.max_nd_count = 8000

##### TD3X2 to be verified,updated same as TD3X3#########
TD3X2 = SpyTestDict()
TD3X2.ipv4_scale = 6000
TD3X2.ipv6_scale = 1500
TD3X2.ipv6_scale_abv_64 = 1000
TD3X2.ipv4_scale_ipv4ipv6 = 2500
TD3X2.ipv6_scale_ipv4ipv6 = 1500
TD3X2.wait_time = 120
TD3X2.delay_time = 7
TD3X2.retry_time = 8
TD3X2.perf_time = 3
TD3X2.max_arp_count = 10000
TD3X2.max_nd_count = 5000
...
##### TD4 to be verified #########
TD4 = SpyTestDict()
TD4.ipv4_scale = 340000
TD4.ipv6_scale = 340000
TD4.ipv6_scale_abv_64 = 320000
TD4.ipv4_scale_ipv4ipv6 =  176048
TD4.ipv6_scale_ipv4ipv6 =  159578
TD4.wait_time = 100
TD4.delay_time = 10
TD4.retry_time = 6
TD4.perf_time = 6
TD4.max_arp_count = 30000
TD4.max_nd_count = 15000
TD4.host_count = 7500

CAMPUSBLD = SpyTestDict()
CAMPUSBLD.ipv4_scale = 8000
CAMPUSBLD.ipv6_scale = 4000
CAMPUSBLD.ipv6_scale_abv_64 = 4000
CAMPUSBLD.ipv4_scale_ipv4ipv6 =  4000
CAMPUSBLD.ipv6_scale_ipv4ipv6 =  2000
CAMPUSBLD.wait_time = 140
CAMPUSBLD.delay_time = 10
CAMPUSBLD.retry_time = 11
CAMPUSBLD.perf_time = 5
CAMPUSBLD.max_arp_count = 6100
CAMPUSBLD.max_nd_count = 2500
CAMPUSBLD.host_count = 1000

TH4 = SpyTestDict()
TH4.ipv4_scale = 1000000
TH4.ipv6_scale = 1000000
TH4.ipv6_scale_abv_64 = 25000
TH4.ipv4_scale_ipv4ipv6 =  80000
TH4.ipv6_scale_ipv4ipv6 =  12000
TH4.wait_time = 140
TH4.delay_time = 10
TH4.retry_time = 11
TH4.perf_time = 5
TH4.max_arp_count = 16000
TH4.max_nd_count = 8000
